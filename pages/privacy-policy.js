...
export default function PrivacyPolicy() {
  return (
    <div className={styles.container}>
      <Head>
        <title>Privacy Policy | AI Meetup - La community italiana sull'Intelligenza Artificiale</title>
        <meta name="description" content="Informativa sulla privacy di AI Meetup, la community italiana che rende l'intelligenza artificiale accessibile a tutti. Scopri come trattiamo i tuoi dati personali." />
        ...
        {/* Canonical URL */}
        <link rel="canonical" href="https://biella.aimeetup.it/privacy-policy" />

        {/* Open Graph */}
        <meta property="og:title" content="Privacy Policy | AI Meetup" />
        <meta property="og:description" content="Informativa sulla privacy di AI Meetup, la community italiana che rende l'intelligenza artificiale accessibile a tutti." />
        <meta property="og:url" content="https://biella.aimeetup.it/privacy-policy" />
        <meta property="og:type" content="website" />
        <meta property="og:site_name" content="AI Meetup" />

        {/* Schema.org JSON-LD rimane per assistere gli utenti che accedono direttamente alla pagina */}
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "@type": "WebPage",
              "@id": "https://biella.aimeetup.it/privacy-policy/#webpage",
              "url": "https://biella.aimeetup.it/privacy-policy",
              "name": "Privacy Policy | AI Meetup",
              "description": "Informativa sulla privacy di AI Meetup, la community italiana che rende l'intelligenza artificiale accessibile a tutti.",
              "isPartOf": {
                "@id": "https://biella.aimeetup.it/#website"
              },
              "inLanguage": "it-IT",
              "breadcrumb": {
                "@id": "https://biella.aimeetup.it/privacy-policy/#breadcrumb"
              },
              "datePublished": "2025-04-10T10:00:00+00:00",
              "dateModified": "2025-04-10T10:00:00+00:00"
            })
          }}
        />
